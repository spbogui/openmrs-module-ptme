...
public class BirthFormValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        if(form == null) {
            ...
            ValidationUtils.rejectIfEmpty(errors, "deliveryDate", "ptme.field.required");
            ValidationUtils.rejectIfEmpty(errors, "homeBirth", "ptme.field.required");
            ...
            if(form.getConsultationDate() != null && form.getPregnantPatientId() != null) {
                Consultation consultation = Context.getService(PreventTransmissionService.class)
                        .getPatientConsultationByDate(form.getPregnantPatientId(), form.getConsultationDate());
                if (consultation != null) {
                    if (form.getConsultationId() == null ||
                            (form.getConsultationId() != null && !consultation.getConsultationId().equals(form.getConsultationId()))) {
                        errors.rejectValue("consultationDate", "ptme.consultation.date.already.done");
                    }
                }
            }
