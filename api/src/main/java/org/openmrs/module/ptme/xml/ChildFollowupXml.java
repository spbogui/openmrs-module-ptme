...
public class ChildFollowupXml implements Converter {
    ...
    public void marshal(Object value, HierarchicalStreamWriter writer, MarshallingContext context) {
        ...
        writer.addAttribute("pcr1SamplingDate", dateFormatter.format(cf.getPcr1SamplingDate()));
        ...
        writer.addAttribute("pcr2SamplingDate", dateFormatter.format(cf.getPcr2SamplingDate()));
        ...
        writer.addAttribute("pcr3SamplingDate", dateFormatter.format(cf.getPcr3SamplingDate()));
        ...
        writer.addAttribute("ctxInitiationDate", dateFormatter.format(cf.getCtxInitiationDate()));
        ...
        writer.addAttribute("inhInitiationDate", dateFormatter.format(cf.getInhInitiationDate()));
        ...
        writer.addAttribute("hivSerology1Date", dateFormatter.format(cf.getHivSerology1Date()));
        ...
        writer.addAttribute("hivSerology2Date", dateFormatter.format(cf.getHivSerology2Date()));
        ...
        writer.addAttribute("followupResultDate", dateFormatter.format(cf.getFollowupResultDate()));
        writer.addAttribute("referenceLocation", cf.getReferenceLocation());
        if (cf.isVoided()) {
